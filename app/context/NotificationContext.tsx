...
const NotificationContext = createContext<NotificationContext>({ displayNotification: () => null });
...
{notifications.map(notification => <ToastNotification key={notification.id} onCloseButtonClick={() => closeNotification(notification.id)} kind="success" style={{
